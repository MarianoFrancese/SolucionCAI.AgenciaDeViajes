namespace SolucionCAI.AgenciaDeViajes
{
    partial class Presupuesto
    {
        ...
        private void InitializeComponent()
        {
            ...
            dataGridView3.Columns.AddRange(new DataGridViewColumn[] { IdProductoHotel, CodHotel, Column22, CodCiudad, Column31, Column32, Column24, Column25, Column26, Column28, TarifaEstadia, TipoAdulto, TipoMenor, TipoInfante, Column30 });
            ...
            dataGridView2.Columns.AddRange(new DataGridViewColumn[] { IdProducto, Column14, Column16, Column15, Column18, Column19, TotalProducto, Column13 });
            ...
            // textBox11
            // 
            textBox11.BackColor = Color.FromArgb(255, 255, 192);
        ...
        private DataGridViewTextBoxColumn IdProductoHotel;
